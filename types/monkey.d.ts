...
declare function GM_addValueChangeListener(
  name: string,
  listener: Monkey.ValueChangeListener
): number;
...
declare function GM_download(
  details: Monkey.DownloadRequest
): Monkey.AbortHandle<boolean>;
...
declare function GM_openInTab(
  url: string,
  options?: Monkey.OpenTabOptions | boolean
): Monkey.OpenTabObject;
...
declare function GM_notification(
  details: Monkey.NotificationDetails,
  ondone?: Monkey.NotificationOnDone
): void;
